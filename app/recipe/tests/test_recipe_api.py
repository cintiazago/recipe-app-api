...
class PrivateRecipeApiTests(TestCase):
    """Test the private recipe API with unauthorized access"""
    def setUp(self):
        self.client = APIClient()
    ...
    def test_recipes_limited_to_user(self):
        """Test that ingredients returned are for the authorized user"""
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'Chicke tikka', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with scpecific tags"""
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes with scpecific ingredients"""
